...
- Fork the repo.
- Go to https://dashboard.heroku.com/new?template=https://github.com/THEG77/nitro-sniper-enhanced making sure to change `YOURUSERNAME` in the url to your actual github username.
